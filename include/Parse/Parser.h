...
private:
  ...
  Stmt *ParseTerminatedStmtList();
  Stmt *ParseUnterminatedStmtList();
  Stmt *ParseTerminatedStmt();
  Stmt *ParseUnterminatedStmt();
  Stmt *ParseTerminableStmt();
  Stmt *ParseSimpleStmtOpt();
  Stmt *ParseSimplestmt();
  PrintStmt *ParsePrintStmt();
  PrintStmt *ParseSimplePrintStmt();
  Expr *ParseOutputRedirection();
  std::vector<Expr *> ParseExprListOpt();
  std::vector<Expr *> ParseExprList();
  std::vector<Expr *> ParseMultipleExprList();
  Expr *ParseExprOpt();
  Expr *ParseExpr();
  std::vector<Expr *> PrintExprListOpt();
  std::vector<Expr *> PrintExprList();
  Expr *ParsePrintExpr();
  Expr *ParseUnaryPrintExpr();
  Expr *ParseNonUnaryPrintExpr();
  Expr *ParseLvalue();
  Expr *ParseNonUnaryInputFunction();
  Expr *ParseUnaryInputFunction();
  Expr *ParseSimpleGet();
  void ParseNewlineOpt();
};
} // namespace cawk
